...
// Generated: 2025-08-21T18:55:29.919Z
// Section: cta
// Category: cta
...
export default function PricingCTA() {
  const stats = [
    ...
    { value: "100+", label: "Accounting Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the thousands of small and medium-sized businesses who trust Acme Accounting Solutions
                to streamline their financial operations. Start your free trial today and experience the
                difference.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading businesses in the industry
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Trial, No Commitment</h3>
              <p className="text-sm text-muted-foreground">
                Try Acme Accounting Solutions for 14 days, no credit card required.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Acme Accounting Solutions is built with enterprise-grade security and 99.99% uptime.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Seamless Setup</h3>
              <p className="text-sm text-muted-foreground">
                Get started with Acme Accounting Solutions in minutes with our guided setup process.
              </p>
            </div>
          </div>
        </div>

...
// Generated: 2025-08-21T18:55:28.443Z
// Section: footer
// Category: footer
  ...
  const footerSections = [
    {
      title: "Services",
      links: [
        { name: "Tax Preparation", href: "#tax-prep" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">Acme Accounting</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Trusted accounting solutions for small businesses and individuals. 
                Helping you navigate the complexities of finance with confidence.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">info@acmeaccounting.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates and offers from Acme Accounting. No spam, unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Acme Accounting. All rights reserved.</span>
